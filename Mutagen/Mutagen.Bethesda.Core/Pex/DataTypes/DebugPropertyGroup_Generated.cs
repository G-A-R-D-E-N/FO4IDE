...
namespace Mutagen.Bethesda.Pex
{
        ...
        ILoquiObjectSetter<DebugPropertyGroup>
    {
            ...
            IMask<TItem>
        {
            ...
            public Mask(TItem initialValue)
            {
                ...
                this.PropertyNames = new MaskItem<TItem, IEnumerable<(int Index, TItem Value)>?>(initialValue, []);
            }
                ...
                TItem PropertyNames)
            {
                ...
                this.PropertyNames = new MaskItem<TItem, IEnumerable<(int Index, TItem Value)>?>(PropertyNames, []);
            }
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                {
                    obj.PropertyNames = new MaskItem<R, IEnumerable<(int Index, R Value)>?>(eval(this.PropertyNames.Overall), []);
            ...
            public string Print(DebugPropertyGroup.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, DebugPropertyGroup.Mask<bool>? printMask = null)
            {
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.PropertyNames = new MaskItem<Exception?, IEnumerable<(int Index, Exception Value)>?>(Noggog.ExceptionExt.Combine(this.PropertyNames?.Overall, rhs.PropertyNames?.Overall), Noggog.ExceptionExt.Combine(this.PropertyNames?.Specific, rhs.PropertyNames?.Specific));
                return ret;
            }
    ...
    public static partial class DebugPropertyGroupMixIn
    {
        ...
        {
            return ((DebugPropertyGroupCommon)((IDebugPropertyGroupGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            DebugPropertyGroup.Mask<bool>? printMask = null)
        {
            ((DebugPropertyGroupCommon)((IDebugPropertyGroupGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
