...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<BipedBodyTemplate>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((BipedBodyTemplateCommon)((IBipedBodyTemplateGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IBipedBodyTemplateGetter? obj)
        {
            return ((BipedBodyTemplateCommon)((IBipedBodyTemplateGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class BipedBodyTemplateCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)BipedBodyTemplate_FieldIndex.FirstPersonFlags) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IBipedBodyTemplateGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
