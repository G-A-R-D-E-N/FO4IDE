...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class AmbientColors_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.AmbientColors";
    ...
    internal partial class AmbientColorsCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAmbientColorsGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
