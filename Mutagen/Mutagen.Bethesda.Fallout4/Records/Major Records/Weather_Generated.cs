...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal enum Weather_FieldIndex
    {
        ...
        Sounds = 68,
        SkyStatics = 69,
        ImageSpaceSunrise = 70,
        ImageSpaceDay = 71,
        ImageSpaceSunset = 72,
        ImageSpaceNight = 73,
        ImageSpaceEarlySunrise = 74,
        ImageSpaceLateSunrise = 75,
        ImageSpaceEarlySunset = 76,
        ImageSpaceLateSunset = 77,
        GodRays = 78,
        DirectionalAmbientLightingColors = 79,
        Aurora = 80,
    ...
    internal partial class WeatherCommon : Fallout4MajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IWeatherGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in GodRaysItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IWeatherGetter
    {
        ...
        public IWeatherGodRaysGetter? GodRays => _GodRaysLocation.HasValue ? WeatherGodRaysBinaryOverlay.WeatherGodRaysFactory(_recordData.Slice(_GodRaysLocation!.Value.Min), _package) : default;
        #endregion
        #region DirectionalAmbientLightingColors
