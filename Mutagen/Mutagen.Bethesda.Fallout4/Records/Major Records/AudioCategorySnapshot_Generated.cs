        ...
        ILoquiObjectSetter<AudioCategorySnapshot>
    {
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.Multipliers = new MaskItem<Exception?, IEnumerable<MaskItem<Exception?, AudioCategoryMultiplier.ErrorMask?>>?>(Noggog.ExceptionExt.Combine(this.Multipliers?.Overall, rhs.Multipliers?.Overall), Noggog.ExceptionExt.Combine(this.Multipliers?.Specific, rhs.Multipliers?.Specific));
                return ret;
            }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class AudioCategorySnapshotCommon : Fallout4MajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAudioCategorySnapshotGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.Multipliers.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
