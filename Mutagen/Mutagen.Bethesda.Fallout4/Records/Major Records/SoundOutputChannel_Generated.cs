...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ISoundOutputChannel
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((SoundOutputChannelCommon)((ISoundOutputChannelGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ISoundOutputChannelGetter? obj)
        {
            return ((SoundOutputChannelCommon)((ISoundOutputChannelGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(SoundOutputChannel.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, SoundOutputChannel.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(SoundOutputChannel.Mask<TItem>)} =>");
                using (sb.Brace())
                {
                    if (printMask?.L ?? true)
                    {
    ...
    public static partial class SoundOutputChannelMixIn
    {
        ...
        {
            return ((SoundOutputChannelCommon)((ISoundOutputChannelGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            SoundOutputChannel.Mask<bool>? printMask = null)
        {
            ((SoundOutputChannelCommon)((ISoundOutputChannelGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class SoundOutputChannelCommon
    {
            ...
            SoundOutputChannel.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"SoundOutputChannel =>");
            }
            else
            {
                sb.AppendLine($"{name} (SoundOutputChannel) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            SoundOutputChannel.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.C ?? true)
            {
                sb.AppendItem(item.C, "C");
            }
            if (printMask?.LFE ?? true)
            {
                sb.AppendItem(item.LFE, "LFE");
            }
            if (printMask?.RL ?? true)
            {
                sb.AppendItem(item.RL, "RL");
            }
            if (printMask?.RR ?? true)
            {
                sb.AppendItem(item.RR, "RR");
            }
            if (printMask?.BL ?? true)
            {
                sb.AppendItem(item.BL, "BL");
            }
            if (printMask?.BR ?? true)
            {
                sb.AppendItem(item.BR, "BR");
            }
        }
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.L) ?? true))
            {
                if (lhs.L != rhs.L) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.R) ?? true))
            {
                if (lhs.R != rhs.R) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.C) ?? true))
            {
                if (lhs.C != rhs.C) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.LFE) ?? true))
            {
                if (lhs.LFE != rhs.LFE) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.RL) ?? true))
            {
                if (lhs.RL != rhs.RL) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.RR) ?? true))
            {
                if (lhs.RR != rhs.RR) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.BL) ?? true))
            {
                if (lhs.BL != rhs.BL) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.BR) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISoundOutputChannelGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public static readonly SoundOutputChannelBinaryWriteTranslation Instance = new();
    ...
    {
        public static readonly SoundOutputChannelBinaryCreateTranslation Instance = new SoundOutputChannelBinaryCreateTranslation();
