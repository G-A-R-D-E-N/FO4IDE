...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        INpcMorph
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((NpcMorphCommon)((INpcMorphGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(INpcMorphGetter? obj)
        {
            return ((NpcMorphCommon)((INpcMorphGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class NpcMorphCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)NpcMorph_FieldIndex.Key) ?? true))
            {
                if (lhs.Key != rhs.Key) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcMorph_FieldIndex.Value) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(INpcMorphGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public static readonly NpcMorphBinaryCreateTranslation Instance = new NpcMorphBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        INpcMorphGetter
    {
        ...
        public UInt32 Key => BinaryPrimitives.ReadUInt32LittleEndian(_structData.Slice(0x0, 0x4));
