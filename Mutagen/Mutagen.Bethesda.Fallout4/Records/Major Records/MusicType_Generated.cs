...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMusicTypeInternal
    {
        ...
        public MusicType(IFallout4Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout4Release)
        {
        ...
        public MusicType(IFallout4Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout4.Internals.RecordTypeInts.MUSC)]
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class MusicType_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.MusicType";
    ...
    internal partial class MusicTypeCommon : Fallout4MajorRecordCommon
    {
        ...
        public static MusicType_FieldIndex ConvertFieldIndex(Fallout4MajorRecord_FieldIndex index)
        {
            switch (index)
            {
    ...
    internal partial class MusicTypeBinaryCreateTranslation : Fallout4MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Data = Mutagen.Bethesda.Fallout4.MusicTypeData.CreateFromBinary(frame: frame);
