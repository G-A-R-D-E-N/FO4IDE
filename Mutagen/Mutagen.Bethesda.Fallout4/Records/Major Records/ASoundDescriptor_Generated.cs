...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<ASoundDescriptor>
    {
        ...
        #region Mutagen
        public virtual IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ASoundDescriptorCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class ASoundDescriptorCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IASoundDescriptorGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
