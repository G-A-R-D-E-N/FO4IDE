...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class GameSetting_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.GameSetting";
    ...
    internal partial class GameSettingCommon : Fallout4MajorRecordCommon
    {
        ...
        public static GameSetting_FieldIndex ConvertFieldIndex(Fallout4MajorRecord_FieldIndex index)
        {
            switch (index)
            {
