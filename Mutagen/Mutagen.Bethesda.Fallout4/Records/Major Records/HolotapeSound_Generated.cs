...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<HolotapeSound>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((HolotapeSoundCommon)((IHolotapeSoundGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IHolotapeSoundGetter? obj)
        {
            return ((HolotapeSoundCommon)((IHolotapeSoundGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(HolotapeSound.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, HolotapeSound.Mask<bool>? printMask = null)
            {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => HolotapeSoundCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class HolotapeSoundMixIn
    {
        ...
        {
            return ((HolotapeSoundCommon)((IHolotapeSoundGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            HolotapeSound.Mask<bool>? printMask = null)
        {
            ((HolotapeSoundCommon)((IHolotapeSoundGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class HolotapeSoundCommon : AHolotapeDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)HolotapeSound_FieldIndex.Sound) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IHolotapeSoundGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public new static readonly HolotapeSoundBinaryWriteTranslation Instance = new();
    ...
    {
        public new static readonly HolotapeSoundBinaryCreateTranslation Instance = new HolotapeSoundBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IHolotapeSoundGetter
    {
        ...
        public IFormLinkNullableGetter<ISoundDescriptorGetter> Sound => FormLinkBinaryTranslation.Instance.NullableOverlayFactory<ISoundDescriptorGetter>(_package, _structData.Span.Slice(0x0, 0x4));
