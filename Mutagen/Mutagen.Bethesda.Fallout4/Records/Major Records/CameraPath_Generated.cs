...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout4.Internals.RecordTypeInts.CPTH)]
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class CameraPath_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.CameraPath";
    ...
    #region Common
    internal partial class CameraPathSetterCommon : Fallout4MajorRecordSetterCommon
    {
    ...
    internal partial class CameraPathCommon : Fallout4MajorRecordCommon
    {
        ...
        public static CameraPath_FieldIndex ConvertFieldIndex(Fallout4MajorRecord_FieldIndex index)
        {
            switch (index)
            {
    ...
    internal partial class CameraPathSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class CameraPathBinaryCreateTranslation : Fallout4MajorRecordBinaryCreateTranslation
    {
