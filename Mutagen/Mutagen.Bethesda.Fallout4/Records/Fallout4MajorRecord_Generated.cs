...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<Fallout4MajorRecord>
    {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => Fallout4MajorRecordCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class Fallout4MajorRecordSetterCommon : MajorRecordSetterCommon
    {
        ...
        public virtual IEnumerable<IMajorRecord> EnumerateMajorRecordsLoopLogic(IFallout4MajorRecordInternal obj)
        {
        ...
        public virtual IEnumerable<IMajorRecordGetter> EnumeratePotentiallyTypedMajorRecords(
            ...
            bool throwIfUnknown)
        {
            if (type == null) return Fallout4MajorRecordCommon.Instance.EnumerateMajorRecords(obj);
            return Fallout4MajorRecordCommon.Instance.EnumerateMajorRecords(obj, type, throwIfUnknown);
        }
        ...
        public virtual IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(
            ...
            bool throwIfUnknown)
        {
            foreach (var item in Fallout4MajorRecordCommon.Instance.EnumerateMajorRecordsLoopLogic(obj, type, throwIfUnknown))
            {
                yield return item;
            }
        }
    ...
    internal partial class Fallout4MajorRecordCommon : MajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IFallout4MajorRecordGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public virtual IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(IFallout4MajorRecordGetter obj)
        {
            yield break;
        }
